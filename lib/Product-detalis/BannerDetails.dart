...
class BannerDetails extends StatefulWidget {
  ...
  int indexpro;
 String dil;
  BannerDetails({required this.dil,required this.pro, required this.indexpro});
...
String url;
  DetailsProduct(
      {required this.url,required this.indexCount, required this.pro, required this.indexpro});
                ...
                children: [
                      ...
                      child: Row(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(widget.url=="ru"?widget.pro.productNameTm:widget.pro.productNameRu),
                          ),
                        ],
                      ),
                    ),
                  ...
                  InkWell(
                    ...
                    child: Container(
                        ...
                        child: (widget.pro.productImage != null)
                            ? CachedNetworkImage(
                          imageUrl:     "${IpAddres()}/" + widget.pro.productImage,
                          fit: BoxFit.contain,
                          height: 350,
                  ...
                  Padding(
                    ...
                    child: Align(
                        ...
                        child: Text(
                         widget.url=='ru'? widget.pro.productDescriptionRu:widget.pro.productDescriptionTm,
                  ...
                  Padding(
                    ...
                    child: Align(
                        alignment: Alignment.topLeft,
                        child: Text(
                         widget.url=='ru'? widget.pro.productNameRu:widget.pro.productNameTm,
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text(
                          widget.pro.productPrice.toString() + " m",
                          style: TextStyle(
                              color: Color.fromRGBO(255, 0, 0, 1), fontSize: 24),
                        ),
                        widget.pro.productPriceOld.toString() != "null"
                            ? Padding(
                                padding: const EdgeInsets.only(left: 18),
                                child: Text(
                                  widget.pro.productPriceOld.toString() + " m",
                                  style: TextStyle(
                                      fontSize: 20,
                  ...
                  Container(
                      padding: const EdgeInsets.only(left: 14, right: 16, top: 30),
                      width: MediaQuery.of(context).size.width ,
                      ...
                      child: widget.indexCount != 0
                        ...
                        child: Row(
                          ...
                          children: [
                                ...
                                onPressed: () async {
                                  ...
                                  if (sa != 0) {
                                    ...
                                    await DatabasHelper.instance
                                        .update(note);
                                    myprice.removePro(widget.pro.productPrice,);
                                  }
                            ...
                            new Text(widget.indexCount.toString()),
                            new IconButton(
                                icon: new Icon(
                                  Icons.add,
                                  color: Colors.red,
                                ...
                                onPressed: () async {
                                  ...
                                  if (sa != 0) {
                                    ...
                                    await DatabasHelper.instance
                                        .update(note);
                                    myprice.addpro(widget.pro.productPrice,);
                                    // 'Harydyň mukdary üýtgedildi');
                                  }
                                })
                          ],
                        ...
                        child: Card(
                          ...
                          child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  SvgPicture.asset("assets/icon/aksebet.svg"),
                                  Container(
                                    padding: EdgeInsets.only(left: 10),
                                    child: Text(sonuc.data!.perewod.add,
                                        style: TextStyle(
