...
class ArzBaha extends StatefulWidget {
  String tertip;

  ArzBaha({required this.tertip});

  @override
  _ArzBahaState createState() => _ArzBahaState();
}

class _ArzBahaState extends State<ArzBaha> {
  ...
  Future<TopProduct> fetchAlbum() async {
    ...
    final response = await  ioClient.get(Uri.parse(widget.tertip == 'true'
        ? "${IpAddres().ipAddress}/public/top-products?sort=0&limit=50"
        : widget.tertip == 'false'
        ? "${IpAddres().ipAddress}/public/top-products?sort=1&limit=50"
        : "${IpAddres().ipAddress}/public/top-products?limit=50"));;
                    ...
                    return Column(
                      children: [
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(Langu.data!.home.arzan),
                                    )
                                  ],
                                ),
                              ),
                              ...
                              children: [
                                Container(
                                  ...
                                  child: FutureBuilder(
                                      future: veri,
                                      builder: (context,
                                          AsyncSnapshot<TopProduct> sonuc) {
                                        if (sonuc.hasData) {
                                          return Column(
                                            mainAxisAlignment:
                        ...
                        FutureBuilder(
                            future: veri,
                            builder:
                                (context, AsyncSnapshot<TopProduct> sonuc) {
                              if (sonuc.hasData) {
                                return Container(
                                    ...
                                    child: GridView.count(
                                        ...
                                        children: List.generate(
                                          sonuc.data!.data.productsWithDiscount
                                              .length,
                                          (index) {
                                            final date = sonuc.data!.data
                                                .productsWithDiscount[index];
                                            addBrend
                                                .add(date.brand.brandNameTm);
                                            return InkWell(
                                              child: Container(
                                                child: Padding(
                                                  padding:
          ...
          if (snapshot.hasData) {
            ...
            return Container(
              child: DiscontPro(
                ...
                addcard: widget.addcard, arrey: widget.arrey,
              ),
            );
          } else {
            return Container(
                      ...
                      children: [
                        ...
                        widget.baharz != "null"
                            ? Padding(
                                ...
                                child: Text(
                                  widget.baharz.toStringAsFixed(1) + ' m',
                                  style: TextStyle(
                                ...
                                widget.stok > widget.itemCount
                                    ? IconButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (widget.stok == widget.itemCount) {
