...
class Ulan extends StatefulWidget {
  const Ulan({Key? key}) : super(key: key);

  @override
  _UlanState createState() => _UlanState();
}

class _UlanState extends State<Ulan> {
  String? url;
