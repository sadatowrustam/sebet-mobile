...
import 'package:sebet/models/CatePro.dart';
...
class CateProduct extends StatefulWidget {
  ...
  CateProduct({required this.tertip, required this.ady, required this.id});
...
class _CateProductState extends State<CateProduct> {
  ...
  Future<List<CatePro>> fetchAlbum() async {
    ...
    final response = await ioClient.get(Uri.parse(widget.tertip == 'true'
        ? "${IpAddres().ipAddress}/public/categories/products/${widget.id}?sort=0&limit=2000"
        : widget.tertip == 'false'
        ? "${IpAddres().ipAddress}/public/categories/products/${widget.id}?sort=1&limit=2000"
        : "${IpAddres().ipAddress}/public/categories/products/${widget.id}?limit=2000"));
    debugPrint(response.statusCode.toString());
    if (response.statusCode == 200) {
      return (json.decode(response.body) as List)
          .map((e) => CatePro.fromJson(e))
          .toList();
    } else {
                    ...
                    return Column(
                      children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                FutureBuilder(
                                    future: veri,
                                    builder: (context,
                                        AsyncSnapshot<List<CatePro>> sonuc) {
                                      if (sonuc.hasData) {
                                        return Container(
                        ...
                        FutureBuilder(
                            future: veri,
                            builder:
                                (context, AsyncSnapshot<List<CatePro>> sonuc) {
                              if (sonuc.hasData) {
                                return Container(
                                          ...
                                          return InkWell(
                                            child: Container(
                                              child: Padding(
                                                ...
                                                child: CheckState(
                                                  add: Langu.data!.perewod.add,
                                                  delete: Langu
                                                      .data!.perewod.delete,
                                                  change: Langu
                                                      .data!.perewod.change,
                                                  end: Langu.data!.perewod.end,
                                                  addcard: Langu
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (sa != 0) {
                                        final note = Note(
                                          ...
                                          brandName:
                                              widget.arrey.brand.brandNameTm,
                                          brandNameRu:
                                              widget.arrey.brand.brandNameRu,
                                          stok: widget
                                              .arrey.productStock.stockQuantity,
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (sa != 0) {
                                            final note = Note(
                                              ...
                                              name: widget.arrey.productNameTm,
                                              nameRu:
                                                  widget.arrey.productNameRu,
                                              brandName: widget
                                                  .arrey.brand.brandNameTm,
                                              brandNameRu: widget
                                                  .arrey.brand.brandNameRu,
                                              stok: widget.arrey.productStock
                                                  .stockQuantity,
                                              img: widget.arrey.productImage,
                                            );
                                            await DatabasHelper.instance
                              ...
                              onTap: () async {
                                ...
                                if (sa == 0) {
                                  ...
                                  final note = Note(
                                    ...
                                    stok:
                                        widget.arrey.productStock.stockQuantity,
                                    img: widget.arrey.productImage,
                                  );
